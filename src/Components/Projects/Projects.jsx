    ...
    <div className="gkp-projects--container">
      ...
      <div className="gkp-projects--projects-container">
        ...
        <section className="row gkp-projects--gifs">
          <div className="row gkp-projects--gif-container">
            <div className="col-lg-4 gkp-projects--social-links-gif">
              <img
                alt="social-links-gif"
                className="gkp-projects--social-link-gif"
                src="../assets/gifs/social-link-gif.gif"
              />
              <p className="gkp-projects--social-links-gif-text">
                This social link tab uses RegEx to validate whether or not the link is a valid URL. The social links that are added are then conditionally rendered on a card in the company's profile page.
              </p>
            </div>
          </div>
        </section>
